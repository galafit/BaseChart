...
/**
 * Data grouping or com.biorecorder.basechart.data binning (banding) with aggregation.
 * Serves to reduce large number of com.biorecorder.basechart.data.
 * <p>
 ...
 * <p>
 * On the com.biorecorder.basechart.chart every bin is represented by one value (point).
 ...
 *  <li>Equal frequencies [equal height binning, quantiles] - each bin has equal number of elements or com.biorecorder.basechart.data points.
 *  Percentile ranks - % of the total com.biorecorder.basechart.data to groupByNumber into bins, or  the number of points in bins are specified. </li>
...
public abstract class GroupedIntSeries implements IntSeries {
  ...
  //  public abstract long getStartBoundary(long groupIndex);
   ...
   // public abstract long getStopBoundary(long groupIndex);
    ...
    /**
     * Serves to synchronize groups(bins) of x and y com.biorecorder.basechart.data series
